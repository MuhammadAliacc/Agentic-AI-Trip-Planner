import os
from utils.place_info_search import OpenStreetMapTool, TavilyPlaceSearchTool
...
class PlaceSearchTool:
    def __init__(self):
        ...
        self.osm_tool = OpenStreetMapTool()
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try:
                ...
                attraction_result = self.osm_tool.search_attractions(place)
